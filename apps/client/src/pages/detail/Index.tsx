...
import { normalizeChain, severityWeight } from "@/lib/siem-types";
    ...
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <div className="mt-3 flex flex-wrap gap-x-5 gap-y-2 text-[10px] text-muted-foreground">
            ...
            <span className="inline-flex items-center gap-1.5"><Clock3 className="size-3" /> {format(new Date(record.created_at), "MMM d, yyyy · HH:mm:ss")}</span>
      ...
      <div className="grid gap-4 lg:grid-cols-[1.15fr_.85fr]">
        <Panel title="AI Incident Summary" eyebrow="PLAIN-ENGLISH EXPLANATION">
          <div className="rounded-lg border border-cyan-500/20 bg-cyan-500/6 p-4">
            <div className="flex items-start gap-3">
              <span className="grid size-8 shrink-0 place-items-center rounded-md bg-cyan-500/12 text-cyan-500">
